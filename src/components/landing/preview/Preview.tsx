  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between pb-4 border-b border-gray-200">
        ...
        <span className="text-xs bg-amber-100 text-amber-700 border border-amber-300 px-3 py-1.5 rounded-full font-semibold">
          Borrador
        </span>
      </div>
      ...
      <div className="space-y-2">
        {[
          ...
          <div
            key={i}
            className="flex items-center justify-between py-2.5 px-4 rounded-xl bg-gray-50 border border-gray-200 text-sm"
          >
      ...
      <div className="space-y-2 pt-2 border-t border-gray-200">
        ...
        <div className="flex justify-between items-center pt-2 border-t border-gray-200">
          ...
          <span className="text-base font-bold text-white bg-[#1B3D7A] px-5 py-2 rounded-xl">
            $8,700
          </span>
        </div>
      </div>
    ...
    <div className="space-y-4">
        ...
        {plantillas.map((pl, i) => (
          <div
            ...
            className={`cursor-pointer rounded-xl overflow-hidden transition-all duration-300 ${
              sel === i
                ? "ring-2 ring-[#1B3D7A] shadow-lg scale-[1.04]"
                : "ring-1 ring-gray-200 hover:ring-gray-400 hover:scale-[1.02]"
            }`}
          >
            <div
            ...
            <div className="bg-gray-50 px-2 py-1.5 text-[10px] font-medium text-gray-600 truncate">
              {pl.nombre}
            </div>
          </div>
        ))}
      ...
      <div className="rounded-xl overflow-hidden border border-gray-200 shadow-sm">
        ...
        <div
          ...
          className="px-4 py-2 flex justify-between border-b border-gray-100"
        >
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-gray-200 overflow-hidden shadow-sm">
        ...
        <div className="bg-[#EEF2FA] px-4 py-2 flex justify-between border-b border-gray-200">
          <div className="font-semibold text-[#1B3D7A] text-xs">
            Constructora Norte SA
          </div>
          <div className="text-xs text-gray-400">Vigencia: 15 días</div>
        </div>
        ...
        <div className="bg-white px-4 py-3 space-y-2">
          ...
          <div className="flex justify-between items-center pt-2 border-t border-gray-100">
            <span className="text-xs font-bold text-gray-700">TOTAL</span>
            <span className="text-xs font-bold text-white bg-[#1B3D7A] px-3 py-1 rounded-lg">
              $8,700
            </span>
          </div>
        </div>
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-4 p-4 bg-red-50 border border-red-200 rounded-xl">
        ...
        <button
          ...
          className={`text-sm px-4 py-2 rounded-xl font-semibold transition-all active:scale-95 whitespace-nowrap ${
            downloaded
      ...
      <div className="rounded-xl border border-gray-200 overflow-hidden shadow-sm">
        ...
        <div className="bg-[#EEF2FA] px-4 py-2 border-b border-gray-100">
          <span className="text-xs text-[#1B3D7A] font-semibold">
      ...
      <div className="grid grid-cols-3 gap-2">
        {["✓ Firma incluida", "✓ Sin marca de agua", "✓ Alta calidad"].map(
          (f, i) => (
            <div
              key={i}
              className="text-xs text-[#1B3D7A] bg-blue-50 border border-blue-200 rounded-xl py-2 text-center font-semibold"
            >
              {f}
            </div>
          )
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="text-left flex-1">
          ...
          <div
            ...
            style={{ color: sent ? "#16a34a" : "rgba(255,255,255,0.75)" }}
          >
      ...
      {sent && (
        <div className="flex items-start gap-3 bg-green-50 border border-green-200 rounded-xl px-4 py-3 text-sm text-green-800">
          ...
          <span>
            Cotización enviada. Tu cliente recibirá una notificación en WhatsApp.
          </span>
        </div>
      )}
    ...
    <>
      ...
      >
        <div ref={sectionRef} className="max-w-5xl mx-auto w-full">
          <div
            className={`text-center reveal-text ${inView ? "visible" : ""}`}
          ...
          >
            ...
            >
              Así funcionan las <span style={{ color: "#1B3D7A" }}>funcionalidades</span>
            </h2>
          ...
          <div key={active} className="grid md:grid-cols-[1fr_1.3fr] gap-12 items-center">
            <div className="anim-text space-y-5">
              ...
              <div className="flex gap-3 pt-2">
                {active > 0 && (
                  <button className="cf-nav-outline" onClick={() => setActive(active - 1)}>
                    ← Anterior
                  </button>
                )}

                {active < tabs.length - 1 ? (
                  <button className="cf-nav-filled" onClick={() => setActive(active + 1)}>
                    Siguiente →
                  </button>
                ) : (
