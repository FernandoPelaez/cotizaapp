...
function withPlan(path: string, plan: PlanSlug) {
  return `${path}?plan=${encodeURIComponent(plan)}`
}

function getPostLoginUrl(plan: PlanSlug) {
...
export default function SignInForm({
  ...
  const registerHref = withPlan("/auth/register", plan)
  const postLoginUrl = getPostLoginUrl(plan)
  ...
  useGSAP(
    () => {
      ...
      tl.from(".page-enter", {
        ...
        .from(
          ".feature-item",
          { opacity: 0, x: -14, duration: 0.5, stagger: 0.1 },
          "-=0.3"
        )
        .from(
          ".form-enter",
          ...
          >
            ...
            >
              ...
              <p className="text-sm mb-3" style={{ color: "#64748B" }}>
                ...
                <span className="sora font-semibold" style={{ color: "#1B3D7A" }}>
                  CotizaApp
                </span>
              </p>
                ...
                <div className="field-enter">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      style={{
                        background: "#F1F4FA",
                        border: errorMsg ? "1.5px solid #DC2626" : "1.5px solid #C8D3E8",
                        color: "#1E293B",
                      }}
                    />
                  ...
                  {errorMsg && (
                    ...
                    >
                      <span className="sora text-xs font-medium" style={{ color: "#DC2626" }}>
                        {errorMsg}
                      </span>
                    </div>
                  )}
