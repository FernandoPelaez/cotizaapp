    ...
    >
      <div
        style={{
          ...
          height: 220,
          borderRadius: "50%",
          background: "rgba(222, 91, 146, 0.10)",
        }}
      />
      <div
        style={{
          ...
          height: 130,
          borderRadius: "50%",
          background: "rgba(245, 171, 200, 0.14)",
        }}
      />
      <div
        style={{
          ...
          height: 180,
          borderRadius: "50%",
          background: "rgba(201, 63, 123, 0.08)",
        }}
      />
      ...
      >
        <div
          style={{
            ...
            borderRadius: "26px",
            overflow: "hidden",
            boxShadow: "0 18px 44px rgba(99, 35, 65, 0.10)",
          }}
        >
          <div
            style={{
                ...
                {safeData.companyLogo ? (
                  ...
                  <div
                    style={{
                      ...
                      height: 68,
                      borderRadius: 20,
                      background: "linear-gradient(135deg, #f6bdd4 0%, #de5b92 100%)",
                      color: "#ffffff",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Estimada <strong>{safeData.clientName || "Cliente"}</strong>, te presentamos
                  esta propuesta con una estética suave, elegante y profesional,
                  lista para compartirse con claridad.
                </p>
              </div>
              ...
              <div
                style={{
                  ...
                  position: "relative",
                  overflow: "hidden",
                  boxShadow: "0 12px 24px rgba(99, 35, 65, 0.14)",
                  textAlign: "center",
                  display: "flex",
                  flexDirection: "column",
                  justifyContent: "center",
            ...
            <div
              style={{
                ...
                border: `1px solid ${palette.border}`,
                background: "#ffffff",
                boxShadow: "0 1px 4px rgba(99, 35, 65, 0.03)",
              }}
            >
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: "2.05fr 0.8fr 0.55fr 1fr 1fr",
                  gap: 8,
                  padding: "10px 13px",
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: 16,
                  overflow: "hidden",
                  boxShadow: "0 10px 22px rgba(99, 35, 65, 0.05)",
                }}
              >
